...
--» Comentado em 21/08/2023 por HILSON SANTOS, devido ao retorno de venda a consumidor final no CGO 307 para entrega «--
/* 
...
--« Cria em 21/08/2023 por Hilson Santos - Para bloqueios dos pedidos do ECOMMERCE de forma de pagamento BOLETO e CARTÃO DE CRÉDITO no CGO 314 »--
SELECT a.nropedvenda, a.nroempresa, 'CRITICA ECOMMERCE 01' codcritica
FROM mad_pedvenda a, mad_pedvendaitem b
WHERE a.nropedvenda = b.nropedvenda
AND a.nroempresa = b.nroempresa
AND a.nroformapagto IN (3,6)
AND a.codgeraloper = 314
AND a.usuinclusao = 'ECOMMERCE'
...
/*     select vd.nropedvenda, vd.nroempresa, 'Qtd Maior que a permitida'
 ...
 where vd.nropedvenda   = vi.nropedvenda
   ...
   AND vd.situacaoped not in ( 'C', 'F')	
	 ...
	 /* CRIADO POR HILSON SANTOS EM 29/10/2024 */
	 SELECT  
       a.nropedvenda, 
			 a.nroempresa, 
			 'Analise PIX App'
