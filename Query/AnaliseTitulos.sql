SELECT 
    ...
    d.seqpessoa                   AS  codcob,         --> Código de cobrança
    ...
    NULL                          AS  nossonumbco,    --> Código do cliente no banco (Se pronta entrega)
    NULL                          AS  boleto,         --> Informar se tem boleto?
    NULL                          AS  recebivel,      --> Indicar se o título pode ser recebido pelo vendedor (Se pronto entrega)
